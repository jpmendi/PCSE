...
uint8_t valor = 0; //valor de PWM

DEBUG_PRINT_ENABLE
;
//Para configurar los mensajes por monitor
...
void writeValue(void* taskParmPtr);  //Escribe en la tarjeta

void diskTickHook(void* taskParmPtr);
...
int main(void)
{
	...
	xTaskCreate(ReceiveBT,                     // Funcion de la tarea a ejecutar
	...
	xTaskCreate(pwmMotor,                     // Funcion de la tarea a ejecutar
	...
	xTaskCreate(diskTickHook,                  // Funcion de la tarea a ejecutar
			(const char *) "diskTickHook", // Nombre de la tarea como String amigable para el usuario
			configMINIMAL_STACK_SIZE * 2, // Cantidad de stack de la tarea
			0,                          // Parametros de tarea
			tskIDLE_PRIORITY + 2,         // Prioridad de la tarea
			0                         // Puntero a la tarea creada en el sistema
	...
	xTaskCreate(writeValue,                    // Funcion de la tarea a ejecutar
			(const char *) "writeValue", // Nombre de la tarea como String amigable para el usuario
			configMINIMAL_STACK_SIZE * 2, // Cantidad de stack de la tarea
			0,                          // Parametros de tarea
			tskIDLE_PRIORITY + 2,         // Prioridad de la tarea
			0                         // Puntero a la tarea creada en el sistema
...
void writeValue(void* taskParmPtr)
{
	FSSDC_InitSPI();
